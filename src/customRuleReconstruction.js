...
// surea11y revives a customRules runInPage/applicability STRING back into a
...
// Converts a live function to a source string surea11y can revive on the
...
// surea11y uses can't parse it back as a standalone expression. Verified
...
function toReconstructableSource(fn) {
  ...
  // name) -- hand back the plain toString() anyway; surea11y's own revival
